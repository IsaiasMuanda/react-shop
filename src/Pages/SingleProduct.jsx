      ...
      <div className="container content">
        <div className="row">
          ...
          <div className="col-lg-7">
            ...
            <button className="btn btn-primary btn-sm" onClick={() => navigate('/products')}>NAVEGAR PARA PRODUCTOS</button> &nbsp;
            <Link to="/products" className="btn btn-primary btn-sm">PRODUCTOS</Link>
          </div>
        </div>
      </div>
    </main>
